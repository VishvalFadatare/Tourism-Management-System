<?php 
   ...
   $registration=registration_listing();
 ?>  
...
<body>
	...
	<a href="registration.php" class="btn btn-info">Back</a>
        <h1 style="text-align: center;">Customer Registration List....!</h1>
	...
	<?php } ?>
	    ...
	    <table id="example" class="display"> 
            ...
            <tbody>
	           	<?php $i=1; foreach($registration as $val){ ?> 
		    	<tr>
		    		<th><?php echo $i; ?></th>
